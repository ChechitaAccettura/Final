  ...
  function obtenerDatos() {
    ...
    .then(data => { //Recibe esos datos y crea la variable data que va a contener todos los datos en formato JSON que se obtienen utilizando la función fetch.
        ...
        const cardDeck = document.getElementById('productos');
...
obtenerDatos();
  ...
  // Ejecutar la función obtenerDatos cada 50 segundos utilizando setInterval
setInterval(obtenerDatos, 50000);  